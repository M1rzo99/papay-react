...
export function Events() {
  const events_list = [
    {
      title: "Pitsaga marhamat azizlar!",
      desc: "Yangicha uslubda Yangicha Tam va Yangicha His",
      author: "Abdurohmaon Mufid",
      date: "2022/09/01",
    ...
    },
    {
      ...
      img: "/restaurant/shutterstock.jpeg",
    },
    {
      ...
      author: "ChickenHouse",
      date: "2023/11/23",
      location: "KHorezm, Urgench",
      img: "/restaurant/lede.jpeg",
    },
    {
      title: "Yangicha Yondashuv Endi O'zbekistonda!!",
      desc: "O'zbekistondage eng yirik ulgurji bozor.\n",
      author: "Food City",
      date: "2021/02/028",
      location: "Toshkent, Yangi Qo'yliq bozori",
      img: "/restaurant/quare.jpeg",
    },
  ];
  return (
